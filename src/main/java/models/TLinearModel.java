 ...
 */
public class TLinearModel extends TModel {
  ...
  public TLinearModel(double learningRate) {
    this();
    fLearningRate = learningRate;
  }

  public TLinearModel(int setupInitSize, int predictInitSize, int learnInitSize) {
  ...
  protected TAlgorithm getImpl() {
    ...
    predict.add(new TInstruction(TOp.VECTOR_INNER_PRODUCT_OP, kWeightsAddress,
        TMemory.kFeatureVectorAddress, TMemory.kPredictionScalarAddress));
