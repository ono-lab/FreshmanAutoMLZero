...
public class TRandomGenerator extends JDKRandomGenerator {
  ...
  /**
   * 命令の入力として指定できるスカラーのアドレスを一様ランダムに選択し，返却する関数
   */
  public int nextScalarInAddress() {
    return nextInt(0, TMemory.numOfScalarAddresses);
  };

  public int nextScalarInAddressOfPredict() {
    return nextInt(TMemory.kFirstInScalarAddressOfPredict, TMemory.numOfScalarAddresses);
  };

  /**
   * 命令の入力として指定できるベクトルのアドレスを一様ランダムに選択し，返却する関数
   */
  public int nextVectorInAddress() {
    return nextInt(0, TMemory.numOfVectorAddresses);
  };

  /**
   * 命令の入力として指定できる行列のアドレスを一様ランダムに選択し，返却する関数
   */
  public int nextMatrixInAddress() {
    return nextInt(0, TMemory.numOfMatrixAddresses);
  };

  /**
   * 命令の出力として指定できるスカラーのアドレスを一様ランダムに選択し，返却する関数
   */
  public int nextScalarOutAddress() {
    return nextInt(TMemory.kFirstOutScalarAddress, TMemory.numOfScalarAddresses);
  };

  /**
   * 命令の出力として指定できるベクトルのアドレスを一様ランダムに選択し，返却する関数
   */
  public int nextVectorOutAddress() {
    return nextInt(TMemory.kFirstOutVectorAddress, TMemory.numOfVectorAddresses);
  };

  /**
   * 命令の入力として指定できる行列のアドレスを一様ランダムに選択し，返却する関数
   */
  public int nextMatrixOutAddress() {
    return nextInt(TMemory.kFirstOutMatrixAddress, TMemory.numOfMatrixAddresses);
  };
