...
public enum TOp {
  ...
  public static int getInNum(TOp op) {
    return TOp.getIn2MemoryType(op) == null ? 1 : 2;
  }

  public static TMemoryType getIn1MemoryType(TOp op) {
    switch (op) {
      case NO_OP:
  ...
  public static TMemoryType getIn2MemoryType(TOp op) {
    switch (op) {
      case NO_OP:
      case SCALAR_ABS_OP:
      case SCALAR_HEAVYSIDE_OP:
  ...
  public static TMemoryType getOutMemoryType(TOp op) {
    switch (op) {
      case NO_OP:
        return null;
      case SCALAR_SUM_OP:
  ...
  public static boolean isAssignable(TOp op, TVariable reservedVariable1, TVariable reservedVariable2, TVariable variable) {
    TMemoryType in1MemoryType = getIn1MemoryType(op);
    TMemoryType in2MemoryType = getIn2MemoryType(op);
    if (reservedVariable1 != null && reservedVariable2 != null) {
      return false;
    } else if (reservedVariable1 != null) {
      return in1MemoryType == reservedVariable1.getMemoryType() && in2MemoryType == variable.getMemoryType()
          || in2MemoryType == reservedVariable1.getMemoryType() && in1MemoryType == variable.getMemoryType();
    } else {
      return in1MemoryType == variable.getMemoryType() || in2MemoryType == variable.getMemoryType();
    }
  }
}
