 ...
 */
public class TInstructionExecutor {
  ...
  static public int floatToIndex(final float value, final int featuresSize) {
    float size = (float) featuresSize;
    return (int) (size * value);
  }

  static public float indexToFloat(final int index, final int featuresSize) {
    return ((float) (index) + 0.5f) / (float) (featuresSize);
  }
   ...
   */
  public static void execute(final TInstruction instr, final TRandomGenerator rand,
  ...
  static private void executeScalarConstSetOp(final TInstruction instr, final TRandomGenerator rand,
      final TMemory memory) {
    memory.scalar[instr.getOut()] = instr.getActivationData();
  }
  ...
  static private void executeVectorConstSetOp(final TInstruction instr, final TRandomGenerator rand,
      final TMemory memory) {
    TCMatrix out = memory.vector[instr.getOut()];
    int index = floatToIndex(instr.getFloatData0(), memory.getDim());
    out.setValue(index, instr.getFloatData1());
  }
  ...
  static private void executeMatrixConstSetOp(final TInstruction instr, final TRandomGenerator rand,
      final TMemory memory) {
    TCMatrix out = memory.matrix[instr.getOut()];
    int row = floatToIndex(instr.getFloatData0(), memory.getDim());
    int col = floatToIndex(instr.getFloatData1(), memory.getDim());
    out.setValue(row, col, instr.getFloatData2());
  }
  ...
  static private void executeScalarGaussianSetOp(final TInstruction instr,
      final TRandomGenerator rand, final TMemory memory) {
    memory.scalar[instr.getOut()] = rand.nextGaussian(instr.getFloatData0(), instr.getFloatData1());
  }

  static private void executeVectorGaussianSetOp(final TInstruction instr,
      final TRandomGenerator rand, final TMemory memory) {
    TCMatrix out = memory.vector[instr.getOut()];
    rand.fillGaussian(instr.getFloatData0(), instr.getFloatData1(), out);
  }
  ...
  static private void executeScalarUniformSetOp(final TInstruction instr,
      final TRandomGenerator rand, final TMemory memory) {
    memory.scalar[instr.getOut()] = rand.nextDouble(instr.getFloatData0(), instr.getFloatData1());
  }

  static private void executeVectorUniformSetOp(final TInstruction instr,
      final TRandomGenerator rand, final TMemory memory) {
    TCMatrix out = memory.vector[instr.getOut()];
    rand.fillDouble(instr.getFloatData0(), instr.getFloatData1(), out);
  }
